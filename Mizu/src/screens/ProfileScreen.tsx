  ...
  return (
    <Screen>
      ...
      <Card style={styles.appCard}>
        ...
        <View style={styles.divider}/>
        <View style={styles.appRow}><View><Text style={styles.settingTitle}>Sobre o Mizu</Text><Text style={styles.description}>Versão 1.1.0 · dados apenas no aparelho</Text></View></View>
      </Card>
    </Screen>
  );
};
